...
export const HARNESSES_DATA: HarnessesData = {
  ...
  benchmarks: [
    ...
    },
    {
      ...
      description:
        'The current revision of the Terminal-Bench shell-task suite, with repaired and rewritten tasks. Not comparable to the Terminal-Bench column: 2.1 is the harder revision, so the same harness and model pair scores lower on it.',
      maxScore: 100,
      unit: '% solved',
  ...
  results: [
    { harness: 'claude-code', model: 'Claude Opus 4.7', scores: { swe_bench_verified: 74.5, terminal_bench: 52.3, aider_polyglot: 84.2, terminal_bench_2_1: null, swe_lancer: 41.8 } },
    { harness: 'claude-code', model: 'Claude Sonnet 4.6', scores: { swe_bench_verified: 70.6, terminal_bench: 47.1, aider_polyglot: 78.4, terminal_bench_2_1: null, swe_lancer: 36.2 } },
    { harness: 'cursor-agent', model: 'Claude Sonnet 4.6', scores: { swe_bench_verified: 68.4, terminal_bench: 42.0, aider_polyglot: null, terminal_bench_2_1: null, swe_lancer: null } },
    { harness: 'cursor-agent', model: 'GPT-5.5', scores: { swe_bench_verified: 70.1, terminal_bench: 41.5, aider_polyglot: null, terminal_bench_2_1: null, swe_lancer: null } },
    { harness: 'codex-cli', model: 'GPT-5.5', scores: { swe_bench_verified: 72.8, terminal_bench: 48.2, aider_polyglot: 82.1, terminal_bench_2_1: null, swe_lancer: 39.6 } },
    { harness: 'codex-cli', model: 'OpenAI o3', scores: { swe_bench_verified: 69.1, terminal_bench: 40.4, aider_polyglot: 76.9, terminal_bench_2_1: null, swe_lancer: null } },
    { harness: 'aider', model: 'Claude Opus 4.7', scores: { swe_bench_verified: null, terminal_bench: 31.2, aider_polyglot: 84.2, terminal_bench_2_1: null, swe_lancer: null } },
    { harness: 'aider', model: 'GPT-5.5', scores: { swe_bench_verified: null, terminal_bench: 28.5, aider_polyglot: 81.8, terminal_bench_2_1: null, swe_lancer: null } },
    { harness: 'aider', model: 'DeepSeek V4 Pro', scores: { swe_bench_verified: null, terminal_bench: 19.7, aider_polyglot: 73.4, terminal_bench_2_1: null, swe_lancer: null } },
    { harness: 'openhands', model: 'Claude Sonnet 4.6', scores: { swe_bench_verified: 65.8, terminal_bench: 30.1, aider_polyglot: null, terminal_bench_2_1: null, swe_lancer: 28.4 } },
    { harness: 'openhands', model: 'GPT-5.5', scores: { swe_bench_verified: 64.2, terminal_bench: 29.6, aider_polyglot: null, terminal_bench_2_1: null, swe_lancer: null } },
    { harness: 'devin', model: 'Proprietary (Sonnet 4.6 + planner)', scores: { swe_bench_verified: 61.7, terminal_bench: null, aider_polyglot: null, terminal_bench_2_1: null, swe_lancer: 32.5 } },
    { harness: 'cline', model: 'Claude Sonnet 4.6', scores: { swe_bench_verified: 63.4, terminal_bench: null, aider_polyglot: null, terminal_bench_2_1: null, swe_lancer: null } },
    { harness: 'windsurf-cascade', model: 'GPT-5.5', scores: { swe_bench_verified: 64.1, terminal_bench: 37.8, aider_polyglot: null, terminal_bench_2_1: null, swe_lancer: null } },
    { harness: 'windsurf-cascade', model: 'SWE-1 (Codeium)', scores: { swe_bench_verified: 58.2, terminal_bench: 30.4, aider_polyglot: null, terminal_bench_2_1: null, swe_lancer: null } },
    { harness: 'amp', model: 'Claude Sonnet 4.6', scores: { swe_bench_verified: 70.8, terminal_bench: null, aider_polyglot: null, terminal_bench_2_1: null, swe_lancer: null } },
    { harness: 'continue', model: 'Claude Sonnet 4.6', scores: { swe_bench_verified: 52.4, terminal_bench: null, aider_polyglot: null, terminal_bench_2_1: null, swe_lancer: null } },
    { harness: 'roo-code', model: 'Claude Sonnet 4.6', scores: { swe_bench_verified: 57.3, terminal_bench: null, aider_polyglot: null, terminal_bench_2_1: null, swe_lancer: null } },
  ],
};
