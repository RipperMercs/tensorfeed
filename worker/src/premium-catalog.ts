...
export const PREMIUM_CATALOG: PremiumEndpoint[] = [
  ...
  },
  {
    ...
    returns: 'Aggregated OpenFDA counts over a category and field.',
    free_sibling: '/api/health/fda/categories',
    signed: true,
    category: 'misc',
  },
  {
    ...
    returns: 'LLM-ready OpenFDA query results with a per-category flat schema.',
    free_sibling: '/api/health/fda/categories',
    signed: true,
    category: 'misc',
  },
  {
    ...
    returns: 'LLM-ready NASA POWER daily meteorological and solar data for one point.',
    free_sibling: '/api/climate/power/daily',
    signed: true,
    category: 'misc',
  },
  {
    ...
    returns: 'LLM-ready flattened EIA Open Data series.',
    free_sibling: '/api/economy/eia/series',
    signed: true,
    category: 'misc',
  },
  {
    ...
    returns: 'NASA POWER hourly meteorological and solar data for one point.',
    free_sibling: '/api/climate/power/daily',
    signed: true,
    category: 'misc',
  },
  ...
  },
  {
    ...
    strict_premium: false,
    params: [],
    returns: 'Composite macro digest across the tracked economic indicators.',
    free_sibling: '/api/economy/fred/indicators',
    signed: true,
    category: 'misc',
  },
  {
    ...
    strict_premium: true,
    params: [],
    returns: 'Composite recession-risk signal across yield-curve inversion and the Sahm rule with red/yellow/green verdict.',
    free_sibling: '/api/economy/fred/indicators',
    signed: true,
    category: 'misc',
  },
  {
    ...
    returns: 'Full upstream BLS/FRED history with YoY paired series, moving averages, min/max, and trend direction.',
    free_sibling: '/api/economy/fred/indicators',
    signed: true,
    category: 'misc',
  },
  ...
  },
  {
    ...
    credits: 1,
    strict_premium: true,
    params: [{ name: 'model_id', required: true }],
    returns: 'One OpenRouter model as an LLM-ready fact card with normalized pricing and extracted capability flags.',
    free_sibling: '/api/openrouter/models',
    signed: true,
    category: 'misc',
  },
