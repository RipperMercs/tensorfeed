...
export const COMPARISONS: ComparisonMeta[] = [
  ...
  {
    slug: 'qwen3-7-max-vs-claude-opus-4-7',
    modelA: 'qwen3-7-max',
    modelB: 'claude-opus-4-7',
    nameA: 'Qwen3.7-Max',
    nameB: 'Claude Opus 4.7',
    providerA: 'Alibaba',
    providerB: 'Anthropic',
    benchmarkNameA: 'Qwen3.7-Max',
    benchmarkNameB: 'Claude Opus 4.7',
    seoTitle: 'Qwen3.7-Max vs Claude Opus 4.7 (2026): Flagship Reasoning Showdown',
    seoDescription:
      'Qwen3.7-Max vs Claude Opus 4.7 compared head to head. Pricing, 1M context, agentic reasoning, Intelligence Index, MCP ecosystem, and use cases on TensorFeed.',
    intro:
    ...
    verdicts: [
      { category: 'Input pricing', winner: 'A', reason: 'Qwen3.7-Max at $2.50 per million vs Claude Opus 4.7 at $15. Six times cheaper on input.' },
      { category: 'Output pricing', winner: 'A', reason: 'Qwen3.7-Max at $7.50 per million vs Claude Opus 4.7 at $75. Ten times cheaper on output.' },
      { category: 'Context window', winner: 'tie', reason: 'Both models ship a 1,000,000 token input window. Even on raw context budget.' },
      { category: 'Intelligence Index (Artificial Analysis)', winner: 'A', reason: 'Qwen3.7-Max scored 57, first place on the public leaderboard. Claude Opus 4.7 has not been re-scored at the same threshold under this iteration.' },
      { category: 'Coding benchmarks (HumanEval, SWE-bench)', winner: 'B', reason: 'Claude Opus 4.7 published HumanEval at 96.2 and remains the published top result on SWE-bench Verified. Alibaba has not published competitive scores on these specific suites.' },
      { category: 'Academic reasoning (GPQA Diamond, MATH)', winner: 'B', reason: 'Claude Opus 4.7 leads with GPQA Diamond 76.5 and MATH 93.1. Qwen3.7-Max leans more on aggregate Intelligence Index than per-suite reasoning scores.' },
      { category: 'Long-horizon agentic operation', winner: 'A', reason: 'Alibaba claims Qwen3.7-Max can run autonomously for up to 35 hours on multi-step missions. Claude does not publish a comparable continuous-operation figure.' },
      { category: 'MCP and tool ecosystem', winner: 'B', reason: 'Anthropic owns the Model Context Protocol spec and ships first-class MCP tooling. Qwen supports tool use but does not lead the spec.' },
      { category: 'Multimodal input', winner: 'B', reason: 'Claude Opus 4.7 ships native vision. Qwen3.7-Max is text-focused at launch.' },
      { category: 'Cached input discount', winner: 'A', reason: 'Qwen3.7-Max cached input drops to $0.25 per million tokens, a 90 percent discount via OpenRouter. Anthropic offers prompt caching but at a smaller relative discount.' },
    ],
    chooseA: [
  ...
  {
    slug: 'nemotron-3-nano-omni-vs-llama-4-scout',
    modelA: 'nemotron-3-nano-omni',
    modelB: 'llama-4-scout',
    nameA: 'Nemotron 3 Nano Omni',
    nameB: 'Llama 4 Scout',
    providerA: 'NVIDIA',
    providerB: 'Meta',
    benchmarkNameA: 'Nemotron 3 Nano Omni',
    benchmarkNameB: 'Llama 4 Scout',
    seoTitle: 'Nemotron 3 Nano Omni vs Llama 4 Scout (2026): Open Multimodal Showdown',
    seoDescription:
      'NVIDIA Nemotron 3 Nano Omni vs Meta Llama 4 Scout. Open-weight multimodal models compared on context, modalities, hardware fit, and benchmarks on TensorFeed.',
    intro:
    ...
    verdicts: [
      { category: 'Modality coverage', winner: 'A', reason: 'Nemotron handles text, image, video, and audio natively in one model. Llama 4 Scout is text plus vision only.' },
      { category: 'Context window', winner: 'B', reason: 'Llama 4 Scout ships a 10,000,000 token context window vs Nemotron at 256,000. Roughly 40x more raw context.' },
      { category: 'Document intelligence (OCRBenchV2-En)', winner: 'A', reason: 'Nemotron scored 65.8 on OCRBenchV2-En, best-in-class. Llama 4 Scout has no published score on this suite.' },
      { category: 'Video understanding (Video-MME)', winner: 'A', reason: 'Nemotron scored 72.2 on Video-MME. Llama 4 Scout has no native video pathway.' },
      { category: 'Voice interaction (VoiceBench)', winner: 'A', reason: 'Nemotron scored 89.4 on VoiceBench, best-in-class. Llama 4 Scout does not handle audio input.' },
      { category: 'Computer-use (OSWorld)', winner: 'A', reason: 'Nemotron scored 47.4 on OSWorld, best-in-class for open multimodal models at this tier.' },
      { category: 'Architecture efficiency', winner: 'tie', reason: 'Both use sparse activation. Nemotron activates 3B of 30B; Llama 4 Scout uses an MoE pattern. Different tradeoffs, comparable inference economics.' },
      { category: 'Consumer GPU fit', winner: 'A', reason: 'Nemotron ships NVFP4 quantization that runs on a 24GB consumer GPU. Llama 4 Scout typically needs more aggressive quantization or multi-GPU for self-host.' },
      { category: 'Pricing', winner: 'tie', reason: 'Both are open weights with no per-token API fees. Self-hosted infrastructure costs dominate either way.' },
      { category: 'License clarity', winner: 'B', reason: 'Llama 4 Community License has been in market a year with established legal interpretation. NVIDIA Open Model License is newer.' },
    ],
    chooseA: [
  ...
  // ── Added July 5, 2026 ──────────────────────────────────────────────
  {
    slug: 'claude-sonnet-5-vs-claude-opus-4-8',
    modelA: 'claude-sonnet-5',
    modelB: 'claude-opus-4-8',
    nameA: 'Claude Sonnet 5',
    nameB: 'Claude Opus 4.8',
    providerA: 'Anthropic',
    providerB: 'Anthropic',
    benchmarkNameA: 'Claude Sonnet 5',
    benchmarkNameB: 'Claude Opus 4.8',
    seoTitle: 'Claude Sonnet 5 vs Opus 4.8: Pricing, Benchmarks, When to Use Which',
    seoDescription:
      'Claude Sonnet 5 vs Claude Opus 4.8 compared. Introductory $2/$10 Sonnet 5 pricing, Terminal-Bench 2.1, SWE-bench, and when Sonnet 5 replaces Opus on TensorFeed.',
    intro:
      'Claude Sonnet 5 landed June 30, 2026 as Anthropic\'s most agentic Sonnet-class model, and its introductory $2 input / $10 output pricing through August 31 puts it at roughly 40 percent of Opus 4.8\'s $5 / $25. On several agentic benchmarks Sonnet 5 gets close to, and in one case beats, the current flagship: Anthropic\'s own numbers put Sonnet 5 at 80.4 on Terminal-Bench 2.1 (vs Opus 4.8 at 74.6), 85.2 on SWE-bench Verified (vs 88.6), 63.2 on SWE-bench Pro (vs 69.2), and 81.2 on OSWorld-Verified (vs 83.4). Opus 4.8 still wins on the hardest reasoning and knowledge-work tasks, but Sonnet 5 is now the default choice for cost-sensitive agentic pipelines, and for most coding workloads it is the model you should try first.',
    verdicts: [
      { category: 'Introductory pricing', winner: 'A', reason: 'Sonnet 5 costs $2/$10 through August 31, 2026 vs Opus 4.8 at $5/$25 per 1M tokens' },
      { category: 'Terminal-Bench 2.1', winner: 'A', reason: 'Sonnet 5 scores 80.4 vs Opus 4.8 at 74.6, an actual capability win for the cheaper model' },
      { category: 'SWE-bench Verified', winner: 'B', reason: 'Opus 4.8 posts 88.6 vs Sonnet 5 at 85.2' },
      { category: 'SWE-bench Pro', winner: 'B', reason: 'Opus 4.8 posts 69.2 vs Sonnet 5 at 63.2' },
      { category: 'OSWorld-Verified', winner: 'B', reason: 'Opus 4.8 posts 83.4 vs Sonnet 5 at 81.2 on computer use' },
      { category: 'Context window', winner: 'tie', reason: 'Both ship a 1 million token context window (Sonnet 5 adds context compaction)' },
      { category: 'Adaptive thinking', winner: 'tie', reason: 'Both support adaptive thinking; Sonnet 5 goes up to xhigh effort' },
      { category: 'Availability', winner: 'tie', reason: 'Both are on Claude API, Amazon Bedrock, Google Vertex, and Microsoft Foundry' },
    ],
    chooseA: [
      'Cost-sensitive agentic coding pipelines',
      'Terminal-Bench and shell-agent workloads where Sonnet 5 actually beats Opus',
      'High-volume production RAG and knowledge work',
      'New deployments during the introductory pricing window',
    ],
    chooseB: [
      'Hardest whole-repository refactors where the SWE-bench delta matters',
      'Computer-use agents where the extra 2.2 points on OSWorld pays for itself',
      'Existing prompts and evals already tuned to Opus 4.8 behavior',
      'Workloads where the top of Opus\'s reasoning ceiling justifies the price',
    ],
  },
  {
    slug: 'longcat-2-vs-deepseek-v4-pro',
    modelA: 'longcat-2',
    modelB: 'deepseek-v4-pro',
    nameA: 'LongCat-2.0',
    nameB: 'DeepSeek V4 Pro',
    providerA: 'Meituan',
    providerB: 'DeepSeek',
    benchmarkNameA: 'LongCat-2.0',
    benchmarkNameB: 'DeepSeek V4 Pro',
    seoTitle: 'LongCat-2.0 vs DeepSeek V4 Pro: Open-Source Chinese Coding Flagships Compared',
    seoDescription:
      'LongCat-2.0 vs DeepSeek V4 Pro compared. Two MIT-licensed Chinese open-source flagships, 1M context, agentic coding, and self-host verdicts on TensorFeed.',
    intro:
      'China\'s two most consequential open-source coding flagships now sit side by side. Meituan\'s LongCat-2.0 (June 30, 2026) is a 1.6 trillion parameter mixture-of-experts with dynamic activation of 33 to 56 billion parameters per token, native 1M context, MIT license, and 59.5 on SWE-Bench Pro (self-reported). DeepSeek V4 Pro (April 2026) is also 1.6 trillion parameters (49B active per token) with a 1M context under MIT, and it carries an independently reproduced 80.6 on SWE-bench Verified plus a proven track record on OpenRouter. The comparison lines up almost too cleanly: LongCat leads on training-story symbolism (fully trained on domestic Chinese chips) and stealth OpenRouter traction, while V4 Pro leads on verified benchmarks, hosted API pricing, and community mindshare. Independent LongCat verification is still pending; if the SWE-Bench Pro number holds up, this becomes a very tight race.',
    verdicts: [
      { category: 'Verified benchmarks', winner: 'B', reason: 'V4 Pro has independently reproduced scores including 80.6 SWE-bench Verified; LongCat launch numbers are self-reported on SWE-Bench Pro (59.5)' },
      { category: 'Hosted API pricing', winner: 'B', reason: 'V4 Pro is available on the DeepSeek API at $0.435/$0.87 per 1M; LongCat has no first-party paid API on launch day (free previews on OpenRouter and longcat.ai)' },
      { category: 'License', winner: 'tie', reason: 'Both ship under MIT' },
      { category: 'Context window', winner: 'tie', reason: 'Both offer a 1M token context window' },
      { category: 'Training story', winner: 'A', reason: 'LongCat is the first trillion-parameter release trained end-to-end on a 50,000-card domestic Chinese cluster, a milestone for non-Western frontier AI' },
      { category: 'Active parameters', winner: 'A', reason: 'LongCat activates 33 to 56 billion per token dynamically vs V4 Pro\'s fixed 49 billion; more expressive for agentic tasks that vary in difficulty' },
      { category: 'Independent traction', winner: 'B', reason: 'V4 Pro has months of production deployment across OpenRouter and self-hosts; LongCat traction is a stealth preview only, though it hit top three by call volume during that window' },
    ],
    chooseA: [
      'Sovereign or geopolitically sensitive deployments where domestic-chip provenance matters',
      'Agentic workloads with variable per-token difficulty (dynamic activation)',
      'Teams that want to be early on the next Chinese open-source frontier',
      'Research on trillion-parameter MoE training on non-Western hardware',
    ],
    chooseB: [
      'Production systems that need independently verified benchmark performance today',
      'Teams already paying for the DeepSeek hosted API',
      'Workloads that cannot wait for LongCat community verification and tooling to mature',
      'Cost-sensitive inference where V4 Pro\'s hosted pricing is a known quantity',
    ],
  },
  {
