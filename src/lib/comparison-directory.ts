...
export const COMPARISONS: ComparisonMeta[] = [
  ...
  {
    slug: 'gemini-3-7-flash-vs-gemini-3-6-flash',
    modelA: 'gemini-3-7-flash',
    modelB: 'gemini-3-6-flash',
    nameA: 'Gemini 3.7 Flash',
    nameB: 'Gemini 3.6 Flash',
    providerA: 'Google',
    providerB: 'Google',
    benchmarkNameA: 'Gemini 3.7 Flash',
    benchmarkNameB: 'Gemini 3.6 Flash',
    seoTitle: 'Gemini 3.7 Flash vs 3.6 Flash: Half the Price, Real Gains',
    seoDescription:
      'Gemini 3.7 Flash vs Gemini 3.6 Flash compared. Introductory pricing halves to $0.75/$3.75, DeepSWE jumps 48.6 to 65.3, and the window is unchanged. On TensorFeed.',
    intro:
    ...
    verdicts: [
      { category: 'Price through 2026', winner: 'A', reason: '$0.75/$3.75 introductory against $1.50/$7.50, exactly half on both sides of the meter' },
      { category: 'Price from January 2027', winner: 'tie', reason: '3.7 Flash reverts to $1.50/$7.50, identical to 3.6 Flash, so the advantage is time-limited by design' },
      { category: 'Agentic coding (DeepSWE v1.1)', winner: 'A', reason: 'Google reports 65.3 percent against 48.6, a 16.7 point step and much larger than the 3.5 to 3.6 move' },
      { category: 'Frontier coding (FrontierCode 1.1 Main)', winner: 'A', reason: 'Google reports 43.6 percent against 34.4' },
      { category: 'Long-context retrieval', winner: 'A', reason: '97.0 percent on GDM-MRCR v2 at 128K, with the same 1,048,576 token input window on both' },
      { category: 'Context window and modalities', winner: 'tie', reason: 'Both take 1,048,576 input tokens, up to 65,536 output, and text, image, audio, video, and PDF input' },
      { category: 'Independent verification', winner: 'B', reason: '3.6 Flash has Artificial Analysis measurements on record; 3.7 Flash has no independent SWE-bench Verified score yet' },
      { category: 'Production track record', winner: 'B', reason: '3.6 Flash has three weeks of settled prompt behavior, which is thin but is more than zero' },
    ],
    chooseA: [
  ...
  {
    slug: 'qwen3-8-max-vs-claude-opus-5',
    modelA: 'qwen3-8-max',
    ...
    providerA: 'Alibaba',
    providerB: 'Anthropic',
    benchmarkNameA: 'Qwen3.8-Max',
    benchmarkNameB: 'Claude Opus 5',
    seoTitle: 'Qwen3.8-Max vs Claude Opus 5: Price, Benchmarks, Verdict',
    seoDescription:
      'Qwen3.8-Max vs Claude Opus 5 compared. $2/$6 against $5/$25, a 2.4T MoE against a frontier Opus, and a benchmark split that favors each on different work.',
    intro:
    ...
    verdicts: [
      { category: 'Input price', winner: 'A', reason: '$2 per 1M against $5, with implicit cache reads at $0.25' },
      { category: 'Output price', winner: 'A', reason: '$6 per 1M against $25, a better than 4x gap that dominates agentic workloads' },
      { category: 'Software engineering', winner: 'B', reason: 'Qwen posts 67.7 on SWE-bench Pro and 73.5 on FrontierSWE against Fable 5 at 80.0 and 88.8; Opus 5 leads Fable 5 on most published rows' },
      { category: 'Agentic tool use (Terminal-Bench 2.1)', winner: 'A', reason: 'Qwen reports 86.6, ahead of Opus 4.8 and Fable 5 at 84.6 and behind only GPT-5.6 Sol at 88.8' },
      { category: 'Instruction following', winner: 'A', reason: 'Qwen leads IFBench at 82.8 and PaperBench at 93.0' },
      { category: 'Computer use', winner: 'B', reason: 'Anthropic reports 70.6 percent on OSWorld 2.0 for Opus 5 against 66.1 for Fable 5, with no comparable Qwen figure published' },
      { category: 'Context window', winner: 'tie', reason: 'Both ship 1M tokens; Opus 5 documents 128K max output as default and maximum' },
      { category: 'Modalities', winner: 'A', reason: 'Qwen takes native text, image, and video; Opus 5 is text and vision only' },
      { category: 'Deployment and procurement', winner: 'B', reason: 'Opus 5 runs on Claude API, Amazon Bedrock, Google Cloud, and Microsoft Foundry; Qwen3.8-Max is Alibaba Cloud Model Studio, which is a hard stop for some data residency policies' },
    ],
    chooseA: [
  ...
  },
  {
    ...
    providerA: 'xAI',
    providerB: 'OpenAI',
    benchmarkNameA: 'Grok 4.6',
    benchmarkNameB: 'GPT-5.6 Sol',
    seoTitle: 'Grok 4.6 vs GPT-5.6 Sol: Same Index Rank, Very Different Price',
    seoDescription:
      'Grok 4.6 vs GPT-5.6 Sol compared. Artificial Analysis ranks them level, but Grok charges $2/$6 against Sol\'s promotional $4/$20, with a 200K long-context cliff to watch.',
    intro:
      'Artificial Analysis places Grok 4.6, released August 7, 2026, level with GPT-5.6 Sol and above Kimi K3, third overall on its index. That is the whole reason this comparison is interesting, because the two models are not priced anywhere near each other. Sol charges $4 per million input tokens and $20 per million output as of August 21, 2026, down from $5 and $30, with cached input at $0.40. OpenAI lists that rate as promotional through at least November 21, 2026, so the gap narrows for three months and then likely widens again. Grok 4.6 charges $2 and $6 for any request under 200,000 tokens, with cached input at $0.50. The catch is the cliff: once a request crosses 200,000 tokens, Grok rates double to $4 input, $1 cached, and $12 output, and the higher tier applies to every token in that request rather than only the overage. Sol has no equivalent step and ships a full 1 million token window against Grok\'s 500,000. Architecturally Grok 4.6 is the same 1.5 trillion parameter V9 foundation as Grok 4.5 with the entire gain coming from supervised fine-tuning and reinforcement learning, which is xAI\'s explicit bet that post-training beats parameter count at a fixed latency and cost envelope. It is also why 4.6 should be treated as a checkpoint: xAI has signaled a 2.1 trillion parameter Grok 4.7 within weeks and says it will train from scratch monthly through the end of 2026. Sol is the more conservative choice on ecosystem, tooling, enterprise deployment, and the sheer volume of independent evaluation behind it. Grok is the choice if your prompts stay under 200K and the index parity holds up on your own evals.',
    verdicts: [
      { category: 'Price under 200K tokens', winner: 'A', reason: '$2/$6 per 1M against Sol\'s promotional $4/$20, with cached input at $0.50 against $0.40' },
      { category: 'Price above 200K tokens', winner: 'A', reason: 'Grok doubles to $4/$12 on the whole request, level with Sol on input and still cheaper on output, but the cliff wrecks naive cost models' },
      { category: 'Intelligence index rank', winner: 'tie', reason: 'Artificial Analysis places Grok 4.6 level with GPT-5.6 Sol, both third overall' },
      { category: 'Context window', winner: 'B', reason: '1M tokens on Sol against 500K on Grok, with no long-context surcharge on Sol' },
      { category: 'Ecosystem and tooling', winner: 'B', reason: 'OpenAI has the largest developer ecosystem, broader SDK and integration coverage, and more third-party harness support' },
      { category: 'Real-time data', winner: 'A', reason: 'Grok integrates live X platform data, which no OpenAI model matches natively' },
      { category: 'Release stability', winner: 'B', reason: 'xAI signals a 2.1T Grok 4.7 within weeks and monthly from-scratch training, so 4.6 is a short-lived checkpoint' },
      { category: 'Independent benchmark depth', winner: 'B', reason: 'Sol has far more published third-party evaluation; Grok 4.6 rests largely on the Artificial Analysis index placement' },
    ],
    chooseA: [
      'Reasoning and analysis where prompts reliably stay under 200K tokens',
      'Cost-sensitive production traffic at frontier-adjacent quality',
      'Applications that benefit from live X platform data',
      'Teams willing to re-evaluate on a monthly xAI release cadence',
    ],
    chooseB: [
      'Prompts that routinely exceed 200K tokens, where the Grok cliff erases the discount',
      'Full 1M context without a pricing tier change mid-request',
      'Enterprise deployments that need the broadest SDK and integration coverage',
      'Procurement that requires deep independent benchmark evidence',
    ],
  },
  {
    slug: 'gemini-3-6-flash-vs-gemini-3-5-flash',
    modelA: 'gemini-3-6-flash',
    modelB: 'gemini-3-5-flash',
    nameA: 'Gemini 3.6 Flash',
    nameB: 'Gemini 3.5 Flash',
    providerA: 'Google',
    providerB: 'Google',
    benchmarkNameA: 'Gemini 3.6 Flash',
    benchmarkNameB: 'Gemini 3.5 Flash',
    seoTitle: 'Gemini 3.6 Flash vs 3.5 Flash: Cheaper, Faster, Same Index',
    seoDescription:
      'Gemini 3.6 Flash vs Gemini 3.5 Flash compared. Output drops to $7.50 from $9.00, time per task halves, and the Intelligence Index stays flat at 50. On TensorFeed.',
    intro:
    ...
    verdicts: [
      { category: 'Output price per 1M tokens', winner: 'A', reason: '3.6 Flash charges $7.50 vs $9.00 on 3.5 Flash, with input unchanged at $1.50' },
      { category: 'Raw intelligence', winner: 'tie', reason: 'Artificial Analysis scores both at 50 on its Intelligence Index, an explicitly flat result' },
      { category: 'Token efficiency', winner: 'A', reason: '3.6 Flash uses 17 percent fewer output tokens on the Artificial Analysis Index and up to 65 percent fewer on DeepSWE' },
      { category: 'Measured cost per task', winner: 'A', reason: '$0.50 vs $0.59 on the Artificial Analysis task methodology, which compounds with the lower sticker rate' },
      { category: 'Speed per task', winner: 'A', reason: 'Average time per task falls from 2.7 minutes to 1.3, a better than half reduction on the same benchmark set' },
      { category: 'Agentic coding (DeepSWE)', winner: 'A', reason: 'Google reports 49 percent vs 37, with fewer unwanted code edits and fewer execution loops' },
      { category: 'Computer use (OSWorld-Verified)', winner: 'A', reason: 'Google reports 83.0 vs 78.4, and computer use is now a built-in client-side tool via the Gemini API' },
      { category: 'Context window', winner: 'tie', reason: 'Both ship a 1,048,576 token input window with up to 65,536 output tokens' },
      { category: 'Track record', winner: 'B', reason: '3.5 Flash has two months of production use and settled prompt behavior; 3.6 Flash changes verbosity and step count, so tuned prompts and evals need re-testing' },
    ],
    chooseA: [
  ...
  {
    slug: 'gemini-3-6-flash-vs-claude-sonnet-5',
    modelA: 'gemini-3-6-flash',
    modelB: 'claude-sonnet-5',
    nameA: 'Gemini 3.6 Flash',
    nameB: 'Claude Sonnet 5',
    ...
    benchmarkNameA: 'Gemini 3.6 Flash',
    benchmarkNameB: 'Claude Sonnet 5',
    seoTitle: 'Gemini 3.6 Flash vs Claude Sonnet 5: Mid-Tier Head to Head',
    seoDescription:
      'Gemini 3.6 Flash vs Claude Sonnet 5 compared. $1.50/$7.50 against $2/$10, token efficiency against SWE-bench scores, and which mid-tier model fits which job.',
    intro:
      'These are the two default workhorses of mid-2026, and they optimize for different things. Gemini 3.6 Flash, released July 21, costs $1.50 per million input tokens and $7.50 per million output, takes text, image, audio, video, and PDF input, and is engineered around token efficiency: Google reports 17 percent fewer output tokens than its predecessor and Artificial Analysis measured time per task falling to 1.3 minutes. Claude Sonnet 5, released June 30, runs $2 per million input and $10 per million output through August 31, then moves to $3/$15 in September, and leads on published coding numbers with vendor-reported 85.2 percent on SWE-bench Verified and 80.4 percent on Terminal-Bench 2.1. Both ship 1 million token context windows. The trade is roughly this: Sonnet 5 is the stronger single-shot coder on the numbers each vendor published, Gemini 3.6 Flash is cheaper per token today and cheaper still per completed task, and the September Sonnet price step widens that gap by half again. Neither set of scores has been independently reproduced on a common harness, so treat the benchmark rows as claims and run your own workload before committing.',
    verdicts: [
      { category: 'Input price per 1M tokens', winner: 'A', reason: '$1.50 vs $2.00 today, and vs $3.00 once Sonnet 5 introductory pricing ends August 31' },
      { category: 'Output price per 1M tokens', winner: 'A', reason: '$7.50 vs $10.00 today, and vs $15.00 from September' },
      { category: 'Coding (vendor-reported)', winner: 'B', reason: 'Anthropic reports 85.2 percent on SWE-bench Verified and 80.4 on Terminal-Bench 2.1; Google published no comparable Verified number for 3.6 Flash' },
      { category: 'Token efficiency', winner: 'A', reason: '3.6 Flash is explicitly tuned to use fewer output tokens and fewer tool calls per task, which compounds with the lower rate' },
      { category: 'Input modalities', winner: 'A', reason: 'Gemini takes text, image, audio, video, and PDF; Sonnet 5 is text and vision only' },
      { category: 'Context window', winner: 'tie', reason: 'Both ship 1 million tokens; Sonnet 5 adds context compaction, Gemini 3.6 Flash allows 64K output' },
      { category: 'Computer use', winner: 'A', reason: 'Google reports 83.0 on OSWorld-Verified with computer use as a built-in API tool' },
      { category: 'Price stability', winner: 'A', reason: 'Gemini pricing is standing; Sonnet 5 has a scheduled 50 percent increase on September 1, 2026' },
      { category: 'Ecosystem', winner: 'B', reason: 'Sonnet 5 runs on the Claude API, Bedrock, Vertex, and Foundry, and slots into the MCP and Claude Code tooling most agent stacks already target' },
    ],
    chooseA: [
      'High-volume agentic runs where cost per completed task is the binding constraint',
      'Multimodal pipelines that need audio, video, or PDF input natively',
      'Computer-use and GUI automation',
      'Budgets that need a stable rate past September 1',
    ],
    chooseB: [
      'Hard single-shot coding and repository-scale refactors',
      'Stacks already built on MCP, Claude Code, or Bedrock and Foundry deployments',
      'Work that benefits from context compaction on very long sessions',
      'Teams that want one vendor across Sonnet, Opus, and Fable tiers',
    ],
  },
  {
    slug: 'laguna-s-2-1-vs-kimi-k3',
    modelA: 'laguna-s-2-1',
    modelB: 'kimi-k3',
    nameA: 'Laguna S 2.1',
    nameB: 'Kimi K3',
    providerA: 'poolside',
    providerB: 'Moonshot AI',
    benchmarkNameA: 'Laguna S 2.1',
    benchmarkNameB: 'Kimi K3',
    seoTitle: 'Laguna S 2.1 vs Kimi K3: Open Weights You Can Actually Run',
    seoDescription:
      'poolside Laguna S 2.1 vs Moonshot Kimi K3 compared. 118B against 2.8T, $0.10/$0.20 against $3/$15, and which open-weight model a small team can self-host.',
    intro:
    ...
    verdicts: [
      { category: 'Input price per 1M tokens', winner: 'A', reason: '$0.10 vs $3.00 on a cache miss, a 30x gap; K3 narrows it to $0.30 on a cache hit' },
      { category: 'Output price per 1M tokens', winner: 'A', reason: '$0.20 vs $15.00, a 75x gap' },
      { category: 'Self-hosting feasibility', winner: 'A', reason: '~8B active parameters against a 2.8T model needing roughly 1,450GB at 4-bit, so only one of these is runnable without a rack' },
      { category: 'General capability', winner: 'B', reason: 'K3 sits around 57 on the Artificial Analysis Intelligence Index, third or fourth overall, and posts 93.5 percent on GPQA Diamond' },
      { category: 'Multimodal input', winner: 'B', reason: 'K3 takes text, image, and video natively; Laguna S 2.1 is a text and code model' },
      { category: 'Agentic coding', winner: 'A', reason: 'poolside reports 70.2 percent on Terminal-Bench 2.1 in thinking mode and 78.5 on SWE-Bench Multilingual, leading open models of disclosed size' },
      { category: 'Benchmark transparency', winner: 'A', reason: 'poolside published every unedited benchmark trajectory and disclosed its own harness; K3 shipped vendor benchmarks only' },
      { category: 'Weight availability', winner: 'A', reason: 'Laguna weights hit Hugging Face day one under OpenMDW-1.1; K3 weights were promised for July 27 and were not public at launch' },
      { category: 'Context window', winner: 'tie', reason: 'Both ship 1,048,576 tokens; Laguna allows 131K output' },
      { category: 'Jurisdiction', winner: 'A', reason: 'Calls to Moonshot\'s own API are processed under Chinese jurisdiction, which matters for compliance-exposed buyers; poolside is US-based' },
    ],
    chooseA: [
