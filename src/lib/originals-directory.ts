...
export const ORIGINALS: OriginalArticle[] = [
  ...
  {
    slug: 'anthropic-custom-silicon-team-sixth-chip',
    title:
    ...
    readTime: '7 min read',
    description:
      "On Tuesday, August 5, 2026, Anthropic confirmed for the first time that it is building an in-house silicon team to design custom chips for Claude, via a statement to Business Insider prompted by a Silicon Engineer job listing on its careers portal: $320,000 to $485,000, eight disciplines from front-end design through packaging with signal and power integrity, and a hiring bar requiring direct personal contribution to shipped semiconductor designs. The listing says Anthropic works from the chip level up with its silicon partners and is now deepening that investment; a spokesperson said the company will co-design hardware and models so Claude runs faster and more efficiently at customer scale. No timeline, no foundry (TechCrunch reported Samsung talks on July 2), no training-versus-inference target. The context is the most diversified silicon supply chain of any frontier lab: Nvidia GPUs, AWS Trainium2 at Project Rainier scale (~500K chips toward 1M), the $200 billion five-year Google TPU commitment (up to 1M units), Claude inference on Microsoft Maia 200 via Azure, and up to 2 GW of AMD MI450 with $5 billion of AMD equity, first gigawatt H1 2027. With this confirmation every major frontier lab and hyperscaler has a custom silicon program, and Anthropic's version is deliberately the least dramatic: where OpenAI committed to Broadcom, 10 gigawatts, and an H2 2026 deployment calendar now under reported financing pressure, Anthropic announced a team instead of a target. Inside the numbers table, the six-source stack view, the three reads on why a lab renting five platforms designs a sixth (co-design is where the remaining efficiency lives after the software squeeze, a credible internal program is a pricing instrument against three vendors that already wrote equity checks, and inference gross margin is the number the eventual public S-1 lives or dies on at a reported $47 billion run rate against a $200 billion compute commitment), why the first part is almost certainly an inference accelerator (training tolerates rented capacity, inference is the recurring bill), and the skeptic's paragraph (a job listing is not a chip, three to four years to first silicon is the norm, and the with-our-silicon-partners framing tells you the five-vendor stack remains the strategy while the team is a hedge, a co-design channel, and a negotiating chip). Three signposts: whether Anthropic names a chip lead with shipped-silicon lineage from the TPU, Apple silicon, or Dojo alumni pools, whether a foundry or design partner is confirmed by year end, and whether the eventual public S-1 carries a silicon R&D line item or supplier concentration language.",
  },
  {
  ...
  {
    slug: 'qwen38-max-2-dollar-frontier-weights-promise',
    title:
    ...
    readTime: '7 min read',
    description:
      "Over the weekend of August 2 to 3, 2026, Alibaba made Qwen3.8-Max broadly available: a 2.4 trillion parameter mixture-of-experts model with 95 billion active per token, a 1 million token context window, and native text, image, and video input. The launch benchmark that matters is Terminal-Bench 2.1 at 86.6, which lands above Claude Opus 4.8 and Claude Fable 5 (both 84.6) and below GPT-5.6 Sol in max mode (88.8), with vision rows including OSWorld-Verified 86.1, Parametric CAD Bench 91.5, and OmniDocBench 1.5 at 92.1. The price column is the story: $2 per million input tokens, $6 per million output, $0.25 per million cached, against Sol at $5/$30 and Fable 5 at $10/$50, which means an agent trajectory burning 10 million output tokens costs $60 on Qwen, $300 on Sol, and $500 on Fable 5. Five days after OpenAI attacked the price floor from below with the 80 percent Luna cut, Alibaba attacks the flagship tier from the middle. It is the third Chinese frontier release in 19 days (Kimi K3 launched July 16 with weights July 27, DeepSeek V4-Flash-0731 shipped July 31 at $0.28 output), and the three drops cover three tiers: the open-weight flagship, the inference floor, and the hosted frontier at a discount. The caveats: Terminal-Bench 2.1 is one benchmark scored from Alibaba's own launch post, Sol max still holds the top by 2.2 points, and the promised open weights (a first for a Max-class model, due on Hugging Face and ModelScope around August 10) do not exist yet, with no repository and no license file published, in an environment where Treasury has said it will examine Chinese open-source models for IP theft with sanctions and Entity List designations on the table. Inside the numbers table, the six-model pricing comparison, the 19-day pattern read (the capability gap has compressed to a benchmark rounding error, what remains is a capital gap, a trust gap, and a legal gap), why the weights are a promise rather than a release, and the enterprise routing take: regulated workloads stay on American endpoints regardless of price, but batch pipelines and agent experiments that burn output tokens by the hundred million now have a frontier-adjacent option at one fifth to one eighth the cost, and that traffic moves quietly. Three signposts: whether the weights and a clean license actually land on August 10, whether Anthropic reprices Fable 5 (now undercut by its own Opus 5 at half price and by Qwen3.8-Max at a fifth), and whether Treasury's IP review reaches Qwen before or after the weights ship.",
  },
  {
