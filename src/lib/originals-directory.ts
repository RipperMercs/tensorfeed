...
export const ORIGINALS: OriginalArticle[] = [
  {
    slug: 'claude-fermat-prove2me-harness-receipt',
    title:
  ...
  {
    slug: 'fable-5-1-cache-read-cut-agent-pricing-floor',
    title:
  ...
  {
    slug: 'anthropic-off-federal-blacklist-s1-window',
    title:
  ...
  {
    slug: 'genai-mil-chatgpt-grok-il5-anthropic-locked-out',
    title:
  ...
  {
    slug: 'openai-mac-mini-rl-apple-ai-infrastructure',
    title:
  ...
  {
    slug: 'sony-warner-anthropic-music-copyright-s1-clock',
    title:
