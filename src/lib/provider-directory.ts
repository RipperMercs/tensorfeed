...
export const PROVIDERS: ProviderMeta[] = [
  ...
  },
  {
    ...
    seoDescription:
      'Everything about OpenAI. GPT-5.6 Sol Terra Luna pricing after the August 21 cut, GPT-5.5, GPT-4o, o1, ChatGPT, API rates, benchmarks, and status. Updated daily on TensorFeed.',
    intro:
      'OpenAI is the company that launched the modern AI era with ChatGPT in November 2022. On June 26, 2026 it previewed GPT-5.6 as a three-model family (Sol, Terra, Luna) under a US Government limited-preview arrangement, then made all three tiers generally available on July 9, 2026. Pricing has moved twice since. The July 30 cut dropped Luna 80 percent to $0.20 per 1M input and $1.20 output and Terra 20 percent to $2 / $12, leaving the flagship untouched. The August 21 cut finally reached Sol: $4 per 1M input (down from $5), $20 output (down from $30), and $0.40 cached input, the first move on the flagship rate since GPT-5.5 set $5 / $30 in April 2026. OpenAI lists the Sol rate as promotional through at least November 21, 2026, and it applies to the pay-as-you-go API, Codex credits, and eligible ChatGPT Work plans but not to Pro, Plus, or Business subscriptions. In ChatGPT, Free and Go users default to Terra while paid users default to Sol. GPT-5.5 (April 2026) remains broadly available with a 1M context window at the old $5 / $30. GPT-4.5 was removed from ChatGPT on June 26, 2026, following GPT-5.2 Instant, Thinking, and Pro on June 12. OpenAI operates the largest AI developer ecosystem with broad third-party integrations, plugins, and the most recognizable consumer AI brand in the world.',
    founded: '2015',
    headquarters: 'San Francisco, CA',
    ceo: 'Sam Altman',
    keyProducts: ['GPT-5.6 Sol', 'GPT-5.6 Terra', 'GPT-5.6 Luna', 'GPT-5.5', 'GPT-4o', 'GPT-4o Mini', 'o1', 'o3-mini', 'ChatGPT', 'Codex', 'DALL-E'],
    strengths: ['Largest developer ecosystem', 'GPT-5.6 Sol, Terra, and Luna generally available July 9, 2026', 'Flagship Sol cut to $4 / $20 per 1M tokens on August 21, 2026', 'Native audio support in GPT-4o', 'Strong reasoning models (o1, o3)', 'Consumer brand recognition', 'Broad enterprise partnerships'],
  ...
  },
  {
    ...
    intro:
      'xAI is Elon Musk\'s AI company, founded in 2023 and integrated with X (formerly Twitter) for real-time data. On August 7, 2026 it launched Grok 4.6, built on the same 1.5 trillion parameter V9 foundation as Grok 4.5 with the entire upgrade coming from improved supervised fine-tuning and reinforcement learning; xAI positions it against Kimi K3 and Claude Opus 4.8 while preserving Grok 4.5\'s speed and cost envelope. Pricing and specs have since been published: a 500K context window at $2 input / $6 output per 1M with cached input at $0.50 below 200K tokens, doubling to $4 / $12 / $1 on any request that crosses 200K, applied to every token in that request rather than only the overage. Artificial Analysis now places Grok 4.6 above Kimi K3 and level with GPT-5.6 Sol, third overall, at a fraction of Sol\'s $5/$30 rate. A larger 2.1T Grok 4.7 is slated to follow within weeks. Its predecessor Grok 4.5, released July 8, 2026, was xAI\'s first model built specifically for coding and agentic work: fourth on the Artificial Analysis Intelligence Index at $2 input / $6 output per 1M tokens, with cached input at $0.50, a higher-context surcharge above 200K tokens, and a 500K context window narrowed to focus the model on coding. xAI says it plans to train new models from scratch on a monthly cadence through the end of 2026.',
    founded: '2023',
    headquarters: 'Palo Alto, CA',
    ceo: 'Elon Musk',
    keyProducts: ['Grok 4.6', 'Grok 4.5', 'Grok 4.3', 'Grok API', 'Grok in X', 'SuperGrok'],
    strengths: ['Grok 4.6 third on the Artificial Analysis Intelligence Index, level with GPT-5.6 Sol', 'Over 60% cheaper than Opus 4.8 or GPT-5.5', 'Real-time X data integration', 'Coding-focused V9 foundation', 'Monthly from-scratch training cadence'],
  },
  {
    slug: 'zhipu',
    pricingId: 'zhipu',
