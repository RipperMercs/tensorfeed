...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: 'TensorFeed Datasets: AI Ecosystem Daily on Hugging Face',
    description:
      'Daily JSONL snapshots of the AI ecosystem on Hugging Face. 42 feeds, inference-only license, mirror of the live TensorFeed API.',
  ...
  twitter: {
    ...
    description:
      'Daily JSONL snapshots of the AI ecosystem on Hugging Face. 42 feeds, inference-only license.',
  },
  keywords: [
    'AI dataset',
