...
export const metadata: Metadata = {
  ...
  description:
    'Meta-catalog of every major AI benchmark: MMLU-Pro, GPQA, HLE, ARC-AGI-2, AIME 2025, SWE-bench Verified, Aider Polyglot, Terminal-Bench, MMMU-Pro, Tau-Bench, GAIA, OSWorld, BFCL, RULER, and more. Free.',
  ...
  openGraph: {
    ...
    description:
      'Every major AI benchmark with category, status, contamination risk, frontier score, and leaderboard URL.',
