    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-6">
        ...
        <p className="text-text-secondary text-lg max-w-3xl">
          What you actually need to self-host the major open-weights models. VRAM per quantization (FP16, FP8, NVFP4, AWQ INT4, GGUF Q4_K_M), recommended GPU class, license, capabilities. This is the &ldquo;I want to run this myself&rdquo; side of the market. Rent it instead via <Link href="/inference-providers" className="text-accent-primary hover:underline">/inference-providers</Link> (hosted open-weights pricing) or <Link href="/models" className="text-accent-primary hover:underline">/models</Link> (frontier closed-model pricing per token). The closed bar these models are measured against moved on July 24, 2026: <Link href="/models/claude-opus-5" className="text-accent-primary hover:underline">Claude Opus 5</Link> shipped at $5/$25 per 1M tokens, holding Opus 4.8 pricing while posting 70.6 percent on OSWorld 2.0 and 90.8 on BrowseComp (vendor-reported), so the open-vs-closed capability gap widened at an unchanged closed-model price. Compare open models on capability at <Link href="/best-open-source-llms" className="text-accent-primary hover:underline">/best-open-source-llms</Link>. {data?.lastUpdated && `Updated ${data.lastUpdated}.`}
        </p>
