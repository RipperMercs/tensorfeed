...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/originals/claude-fermat-prove2me-harness-receipt`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/fable-5-1-cache-read-cut-agent-pricing-floor`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/anthropic-off-federal-blacklist-s1-window`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/genai-mil-chatgpt-grok-il5-anthropic-locked-out`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/openai-mac-mini-rl-apple-ai-infrastructure`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/sony-warner-anthropic-music-copyright-s1-clock`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/softbank-openai-stake-serial-loans-collateral-stack`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/nvidia-huggingface-13b-open-weights-distribution-moat`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/cyber-defense-letter-116-signers-containment-math`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/thomson-reuters-40m-qwen-two-track-cocounsel`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/jalapeno-benchmarks-watt-win-token-cost-tie`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/openai-monitoring-overhead-20-percent-containment-price`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/arthur-hayes-flop-airdrop-before-genesis`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/claude-protein-binders-gpu-hours-per-binder`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/broadcom-xpv-70b-residual-value-guarantee`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/anthropic-65b-run-rate-gross-net-ipo-restatement`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    ...
    { url: `${baseUrl}/originals/nvidia-105b-openai-ohio-guarantee-shipped`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/stripe-openrouter-7b-agent-stack-consolidation`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/gemini-3-7-flash-half-price-mechanize-coding-loop`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/ultrafast-speed-tier-list-price-expiry`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/deepseek-v4-pro-price-inversion-open-harness`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/glm-5-3-exploit-chains-open-weights-two-week-clock`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/anthropic-watermarks-claude-worldwide-eu-ai-act-floor`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/openai-gpt-56-cyber-93-point-alignment-gap`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/pixel-11-tensor-g6-ram-cut-ondevice-ai`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    ...
    { url: `${baseUrl}/originals/openai-astra-critical-cyber-pause`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/google-deepmind-consolidation-cost-four-fellows`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/cloudflare-wallets-buyer-side-x402-loop-closed`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/kimi-k3-fourth-lab-felony-bench-scoreboard`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/anthropic-silicon-team-sixth-lever`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/alibaba-qwen-3-8-max-open-weights-inference-floor`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/apple-openai-injunction-io-court-clock`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/anthropic-india-in-country-inference-bfsi-unlock`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/eu-ai-act-live-caisi-missed-brussels-briefed-first`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/openai-astra-ten-proofs-2000-compute`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/california-sb-942-live-washington-missed-deadline`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/gpt-56-luna-80-cut-sol-rewrote-inference-stack`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/anthropic-audit-claude-breached-three-orgs-since-april`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/amazon-anthropic-mark-496b-backlog`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/pacing-frontier-letter-endorsement-split`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/microsoft-meta-same-night-capex-verdict`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/openai-anthropic-authored-federal-launch-bar`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    ...
    { url: `${baseUrl}/originals/nvidia-250b-guarantee-credit-rating-rental`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    ...
    { url: `${baseUrl}/originals/kimi-k3-weights-live-self-host-math`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/mcp-stateless-monday-session-handshake-gone`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/hyperscaler-earnings-week-backlog-defense`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/google-cloud-514b-backlog-tpu-in-customer-dc`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/claude-opus-5-same-price-half-of-fable`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/open-weights-coalition-letter-who-didnt-sign`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/amd-anthropic-2gw-mi450-fifth-vendor`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/white-house-moonshot-fable-gb300-treasury-gate`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/openai-hugging-face-sandbox-escape-gate-proof`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/z-ai-1gw-domestic-chips-sovereignty-stack`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/white-house-ai-finra-sec-regulator-frontier`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/anthropic-meta-10b-fourth-compute-vendor`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/thinking-machines-inkling-tinker-bet`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/kimi-k3-open-frontier-ceiling-8x`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/fli-safety-index-conditional-pause-clause`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/new-york-data-center-moratorium-blueprint`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    ...
    { url: `${baseUrl}/originals/sap-prior-labs-europe-frontier-lab`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    ...
    { url: `${baseUrl}/originals/measuring-llm-api-latency-from-the-edge`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/openai-aws-bedrock-24-hours`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/ai-talent-war-billion-dollar-engineers`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/publishing-bot-traffic`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/kv-ops-budget-edge-architecture`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/mcp-server-fifty-line-file`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/why-usdc-over-stripe`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/15-paid-endpoints-24-hours`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/validating-agent-payments-mainnet`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/microsoft-openai-partnership-reset`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/alibaba-happy-horse-video-crown`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/openai-workspace-agents-chatgpt-enterprise`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/anthropic-project-deal-agent-marketplace`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/ai-money-gap-pwc`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/deepseek-v4-open-source-frontier`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/google-anthropic-40b-compute`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/ai-week-april-24-2026`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/gpt-5-5-openai-flagship`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/claude-design-anthropic`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/claude-opus-4-7-release`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/llms-txt-every-developer`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/ai-pricing-floor`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/ai-adoption-faster-than-internet`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/4chan-discovered-chain-of-thought`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/frontier-model-forum-vs-china`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/claude-mythos-ai-security`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/google-notebooklm-gemini`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/stanford-ai-index-2026`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/claude-mythos-not-afraid`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/building-for-ai-agents`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/rise-of-agentic-ai`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/claude-vs-gpt-vs-gemini`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/open-source-llms-closing-gap`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/state-of-ai-apis-2026`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/ai-api-pricing-war-2026`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/ai-service-outages-month`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/claude-code-leak`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/mcp-97-million-installs`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/openai-killed-sora`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/why-we-built-tensorfeed`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
