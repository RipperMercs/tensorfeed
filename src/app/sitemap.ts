...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/originals/moonshot-distillation-charge-gb300-thailand`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/openai-hugging-face-breach-guardrail-asymmetry`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/openai-model-sandbox-escape-30-day-review`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/kimi-k3-largest-open-weight-model-frontier-gap`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${baseUrl}/originals/openai-anthropic-same-state-bills-opposite-endgames`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
