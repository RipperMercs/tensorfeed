...
<hr className="my-10 border-border" />
<h2 id="10-the-path-forward" className="text-2xl sm:text-3xl font-bold text-text-primary mt-12 mb-5 leading-tight scroll-mt-24">10. The Path Forward</h2>
...
<h3 id="101-what-is-incomplete" className="text-xl sm:text-2xl font-semibold text-text-primary mt-8 mb-4 leading-snug scroll-mt-24">10.1 What is incomplete</h3>
...
<h3 id="102-three-predictions-through-2030" className="text-xl sm:text-2xl font-semibold text-text-primary mt-8 mb-4 leading-snug scroll-mt-24">10.2 Three predictions through 2030</h3>
...
<h3 id="103-what-you-can-do" className="text-xl sm:text-2xl font-semibold text-text-primary mt-8 mb-4 leading-snug scroll-mt-24">10.3 What you can do</h3>
...
<h3 id="104-an-invitation" className="text-xl sm:text-2xl font-semibold text-text-primary mt-8 mb-4 leading-snug scroll-mt-24">10.4 An invitation</h3>
...
<hr className="my-10 border-border" />
<h2 id="11-conclusion" className="text-2xl sm:text-3xl font-bold text-text-primary mt-12 mb-5 leading-tight scroll-mt-24">11. Conclusion</h2>
