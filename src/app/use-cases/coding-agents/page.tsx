...
const FAQ_JSONLD = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. The @tensorfeed/mcp-server npm package exposes 59 tools including routing recommendations, SWE-bench history, news search, and webhook watches. Add `npx -y @tensorfeed/mcp-server` to your MCP config. Free tools work without auth; premium tools require a TENSORFEED_TOKEN env var pointing to a tf_live_ bearer token.',
      },
    },
  ],
};
