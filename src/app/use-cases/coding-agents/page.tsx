...
const FAQ_JSONLD = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. The @tensorfeed/mcp-server npm package exposes 24 tools including the signed route_verdict routing decision, benchmark_series, and webhook watches. Add `npx -y @tensorfeed/mcp-server` to your MCP config. Free preview tiers work without auth; paid full results require a TENSORFEED_TOKEN env var pointing to a tf_live_ bearer token.',
      },
    },
  ],
};
