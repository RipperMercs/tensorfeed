...
2. **What feeds are missing?** I want to add what people will actually use. The current 44 feeds cover most of the public AI ecosystem but there are gaps (frontier-lab internal benchmarks, RLHF pipelines, image-gen pricing histories).
